...
--    awful.key({ modkey, "Shift"   }, "q", awesome.quit),
    ...
    -- {{{ Custom program
	-- scrot
    awful.key({   }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/scrot/ 2>/dev/null'") end),
	-- alsamixer
	...
	-- mocp
    awful.key({ mediakey            }, "a",   function () awful.util.spawn("exaile")                      end),
    awful.key({ mediakey            }, "q",   function () awful.util.spawn("killall exaile")              end),
    awful.key({ mediakey            }, "n",   function () awful.util.spawn("exaile -n")                   end),
    awful.key({ mediakey            }, "b",   function () awful.util.spawn("exaile -p")                   end),
    awful.key({ mediakey            }, "p",   function () awful.util.spawn("exaile -t")                   end),
    awful.key({ mediakey            }, "s",   function () awful.util.spawn("exaile -s")                   end)
	-- }}}
)
-- }}}
...
awful.rules.rules = {
  ...
  --{ rule = { class = "Eclipse"      }, properties = { tag = tags[mouse.screen][5] } },
	...
	-- 9 p2p
    { rule = { class = "Transmission" }, properties = { tag = tags[ left_screen][9] } },
}
-- }}}
